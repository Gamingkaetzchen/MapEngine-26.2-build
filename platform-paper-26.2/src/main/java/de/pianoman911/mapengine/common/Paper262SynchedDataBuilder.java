...
public final class Paper262SynchedDataBuilder {
    ...
    private Paper262SynchedDataBuilder() {
    }

    public static Paper262SynchedDataBuilder builder() {
        return new Paper262SynchedDataBuilder();
    }

    public <T> Paper262SynchedDataBuilder setDataItem(EntityDataAccessor<T> accessor, T defaultValue) {
